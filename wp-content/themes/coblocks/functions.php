...
function coblocks_setup() {
	...
	add_theme_support(
		'editor-color-palette', array(
			array(
				'name'  => esc_html__( 'Dark Black', 'coblocks' ),
				'slug'  => 'dark-black',
				'color' => '#040402',
			),
			array(
			...
			array(
				'name'  => esc_html__( 'Medium Gray', 'coblocks' ),
				'slug'  => 'medium-gray',
				'color' => '#8f949e',
			),
			array(
			...
			array(
				'name'  => esc_html__( 'CoBlocks Blue', 'coblocks' ),
				'slug'  => 'coblocks-blue',
				'color' => '#575ffd',
			),
			array(
				'name'  => esc_html__( 'CoBlocks Green', 'coblocks' ),
				'slug'  => 'coblocks-green',
				'color' => '#21e8af',
			),
			array(
				'name'  => esc_html__( 'CoBlocks Orange', 'coblocks' ),
				'slug'  => 'coblocks-orange',
				'color' => '#ff5b44',
			),
			array(
				'name'  => esc_html__( 'CoBlocks Yellow', 'coblocks' ),
...
function coblocks_scripts() {
	...
	// Scripts.
	wp_enqueue_script( 'jquery-fitvids', get_theme_file_uri( '/assets/js/jquery.fitvids.js' ), array( 'jquery' ), '1.1.8', true );
	wp_enqueue_script( 'coblocks-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '1.1.8', true );
	wp_enqueue_script( 'coblocks-navigation', get_theme_file_uri( '/assets/js/navigation.js' ), array( 'jquery' ), '1.1.8', true );
	wp_enqueue_script( 'coblocks-global', get_theme_file_uri( '/assets/js/global.js' ), array( 'jquery' ), '1.1.8', true );
...
function coblocks_gutenberg_styles() {
	...
	wp_enqueue_style( 'coblocks-gutenberg', get_theme_file_uri( '/assets/css/gutenberg.css' ), false, '1.1.8', 'all' );
