...
if ( have_posts() )  :
	...
	while ( have_posts() ) : the_post(); ?>
		...
		<div <?php post_class( 'section-inner' ); ?>>
			...
			<header class="page-header section-inner medium<?php if ( has_post_thumbnail() ) echo ' fade-block'; ?>">
			...
			wp_link_pages( array(
				'before' => '<p class="section-inner medium linked-pages">' . __( 'Pages:', 'hamilton' ),
			) );

			if ( get_post_type() == 'post' ) : ?>

				<div class="meta bottom section-inner medium group">
