<?php get_header(); ?>
	...
	<div class="section-inner">
		...
		if ( have_posts() ) : ?>
			<div class="intro">
				<div class="hello">My name is Terence. I'm a Product Designer.</div>
				<div class="hello">I achieve design simplicity with 3 groups in mind:</div>
				<div class="hello">the users, the business, and the developers.</div>
