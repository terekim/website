...
if ( $the_query->have_posts() ) {
        ...
        echo "<div class='portfolio-container masonry portfolio-thirds " . 'olivo-' . esc_attr( $olivo_lite_portfolio_columns ) . '-columns' . "' data-post-type='" . esc_attr( $olivo_lite_portfolio_display ) . "'>\n\n";
