...
class Pikture_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'pikture';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'pikture' ), $i ),
	...
	function get_footer_widgets_content( $args ) {
		...
		$args = wp_parse_args( (array) $args, array(
			'container'       => 'div',
			'container_class' => $this->custom_footer_widget_class( 'footer-widgets-area page-section clear' ),
			'container_style' => '',
			'container_id'    => '',
			'wrap_class'      => 'hentry',
			'before'          => '',
...
// Initialize.
$pikture_footer_widgets = new Pikture_Footer_Widgets();
