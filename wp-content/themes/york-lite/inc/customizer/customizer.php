...
function york_customize_preview_js() {
	wp_enqueue_script( 'york-customize-preview', get_theme_file_uri( '/assets/js/customize-preview.js' ), array( 'customize-preview' ), '2.0.0', true );
}
...
function york_customize_panel_scripts() {
	wp_enqueue_script( 'york-customize-controls', get_theme_file_uri( '/assets/js/customize-controls.js' ), array( 'customize-controls' ), '2.0.0', true );
	wp_enqueue_style( 'york-customize-controls', get_theme_file_uri( '/assets/css/customize-controls.css' ), '2.0.0', true );
}
