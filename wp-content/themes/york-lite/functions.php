...
function york_scripts() {
	...
	wp_enqueue_style( 'york-fonts', york_fonts_url(), false, '2.0.0', 'all' );

	// Theme stylesheet.
	wp_enqueue_style( 'york-style', get_stylesheet_uri(), false, '2.0.0', 'all' );
	...
	// Scripts.
	wp_enqueue_script( 'york-global', get_theme_file_uri( '/assets/js/global.js' ), array( 'jquery', 'masonry', 'imagesloaded' ), '2.0.0', true );
	wp_enqueue_script( 'york-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '2.0.0', true );
...
function york_editor_frame_styles() {
	wp_enqueue_style( 'york-editor-frame-styles', get_theme_file_uri( '/assets/css/style-editor-frame.css' ), false, '2.0.0', 'all' );
}
